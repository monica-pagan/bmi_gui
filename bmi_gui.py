# -*- coding: utf-8 -*-
"""
Created on Thu Feb  1 08:54:02 2024
...
class MainWindow(qtw.QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout.addRow('Height in Inches', self.username_input)
        layout.addRow('Weight in Pounds', self.username_input2)
        ...
        self.submit_button.clicked.connect(self.weight_func)
...
#        
    def weight_func(self):
        ...
        self.height = float(self.username_input.text())
        self.weight = float(self.username_input2.text())
        outp = bmi_functionality.bmifunction(self.weight, self.height) 
        outp.runbmi()
        bmi_result = outp.bmi_result
        qtw.QMessageBox.information(self, "BMI Output: ", bmi_result)
...
if __name__ == '__main__':
    ...
    w = MainWindow(windowTitle='BMI Calculator')
    w.show()
    sys.exit(app.exec_())
